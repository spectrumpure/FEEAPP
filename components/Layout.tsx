      ...
      `}>
        <div className="flex flex-col h-full p-6">
          <div className="flex items-center space-x-3 mb-10 px-2">
            ...
            <div>
              <h1 className="font-bold text-slate-900 tracking-tight leading-none">EduFee</h1>
              <p className="text-[10px] text-slate-400 font-medium uppercase tracking-widest mt-1">Enterprise Solution</p>
            </div>
          </div>
